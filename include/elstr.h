...
/* elstr.h -- A C library for string manipulation
 *
...
#ifndef LIBELSTR_C_API_H
#define LIBELSTR_C_API_H
...
static inline const char *str_c(const str_ptr s) {
	return s->heap;
}

extern str_ptr  str_new           ();
